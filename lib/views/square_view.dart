...
class SquareParticleView extends StatefulWidget {
  SquareParticleView({Key? key}) : super(key: key);

  @override
  SquareParticleViewState createState() => SquareParticleViewState();
}

class SquareParticleViewState extends State<SquareParticleView>
